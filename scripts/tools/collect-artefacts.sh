...
#
# collect-artefacts.sh — collect fuzzing artefacts into a compressed .tar.xz
...
STAGING=$(mktemp -d --suffix=.syz-artefacts)
ARTIFACT_DIR="$STAGING/artefacts_${TIMESTAMP}"
...
OUTPUT="$SYZKALLER_WORKDIR/artefacts_${TIMESTAMP}.tar.xz"
