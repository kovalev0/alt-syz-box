...
# curl -s https://git.altlinux.org/tasks/archive/done/_407/416834/build/100/x86_64/rpms/kernel-image-6.12-6.12.85-alt0.c10f.2.x86_64.rpm | rpm2cpio | cpio -imdv "./boot/config-6.12.85-6.12-alt0.c10f.2"
cat "$CONTAINER_REPO_DIR/config/kernel/config-6.12.85-6.12-alt0.c10f.2" >> "$KERNEL_BUILD_DIR/.config"
